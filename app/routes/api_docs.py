...
SWAGGER_SPEC = {
    ...
    'paths': {
        ...
        '/customers': {
            'get': {
                'summary': 'Получить список контактов заказчиков',
                'tags': ['Customers'],
                'security': [{'BearerAuth': []}],
                'parameters': [
                    {
            ...
            'post': {
                'summary': 'Создать новый контакт заказчика',
                'tags': ['Customers'],
                'security': [{'BearerAuth': []}],
                'requestBody': {
                    'required': True,
        ...
        '/customers/{customer_id}': {
            'get': {
                'summary': 'Получить контакт заказчика по ID',
                'tags': ['Customers'],
                'security': [{'BearerAuth': []}],
                'parameters': [
                    {
            ...
            'put': {
                'summary': 'Обновить контакт заказчика',
                'tags': ['Customers'],
                'security': [{'BearerAuth': []}],
                'parameters': [
                    {
            ...
            'delete': {
                'summary': 'Удалить контакт заказчика',
                'tags': ['Customers'],
                'security': [{'BearerAuth': []}],
                'parameters': [
                    {
    ...
    'tags': [
        ...
        {'name': 'Customers', 'description': 'Управление контактами заказчиков'},
    ]
}
