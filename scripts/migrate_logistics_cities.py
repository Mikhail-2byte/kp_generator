...
Чита, Улан-Удэ, Иркутск, Красноярск, Новосибирск, Омск, Екатеринбург, Москва, Санкт-Петербург
"""

import json
from pathlib import Path

# Основные города маршрута КНР → Россия
MAIN_ROUTE_CITIES = [
    'Чита', 'Улан-Удэ', 'Иркутск', 'Красноярск', 'Новосибирск', 
    'Омск', 'Екатеринбург', 'Москва', 'Санкт-Петербург'
]
